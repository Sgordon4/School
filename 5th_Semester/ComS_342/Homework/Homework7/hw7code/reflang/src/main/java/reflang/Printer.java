...
public class Printer {
    ...
    public String visit(AST.LetrecExp e, Env env) {
		...
		@Override
		public String visit(AST.LengthStrExp e, Env env) {
			String result = "(length ";
			result += e.getStrExpr().accept(this, env);
			return result + ")";
		}
		...
		public String visit(AST.RefExp e, Env env) {
			String result = "(ref ";
			result += e.get_value_exp().accept(this, env);
			return result + ")";
		}
		...
		public String visit(AST.AssignExp e, Env env) {
			String result = "(set! ";
			result += e.get_loc_exp().accept(this, env) + " ";
			result += e.get_value_exp().accept(this, env);
			return result + ")";
		}
