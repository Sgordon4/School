...
insert into courses (number, name, description, credithours, level, department_code) values (311, 'Algorithm', 'Design and
Analysis', 3, Undergraduate, 401);

insert into courses (number, name, description, credithours, level, department_code) values (531, 'Theory of
Computation', 'Theorem and Probability', 3, Graduate, 401);
