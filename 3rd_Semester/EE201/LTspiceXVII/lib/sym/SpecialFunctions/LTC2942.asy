...
SYMATTR Prefix X
SYMATTR SpiceModel LTC2942
SYMATTR Description Battery Gas Gauge with Temperature, Voltage Measurement (Temperature not modeled)
SYMATTR Value2 EF_Reg=65535 GH_Reg=0
SYMATTR ModelFile LTC2942.sub
PIN -160 -96 LEFT 8
