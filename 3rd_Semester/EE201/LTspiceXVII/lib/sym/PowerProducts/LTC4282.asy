...
WINDOW 39 0 119 Center 2
WINDOW 40 0 160 Center 2
SYMATTR Value LTC4282
SYMATTR Value2 OVRTRY=1 UVRTRY=1 OCRTRY=0
SYMATTR SpiceLine FETBADRTRY=1 FETBADTIMOUT=10m
SYMATTR Prefix X
SYMATTR Description High Current Hot Swap Controller with I2C Compatible Monitoring
SYMATTR ModelFile LTC4282.sub
SYMATTR SpiceLine2 ILIM_ADJUST=4
PIN -432 96 LEFT 8
PINATTR PinName ON
