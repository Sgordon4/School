...
SYMATTR Value LTC1682-3.3
SYMATTR Prefix X
SYMATTR SpiceModel LTC1682-3.3.sub
SYMATTR Value2 LTC1682-3.3
SYMATTR Description Doubler Charge Pump with Low Noise Linear Regulator, Fixed 3.3V Output
PIN -144 -96 LEFT 8
