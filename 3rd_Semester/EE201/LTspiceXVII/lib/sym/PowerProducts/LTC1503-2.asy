...
SYMATTR Value LTC1503-2
SYMATTR Prefix X
SYMATTR SpiceModel LTC1503-2.sub
SYMATTR Value2 LTC1503-2
SYMATTR Description High Efficiency Inductorless Step-Down DC/DC Converter, Fixed 2V Output
PIN -144 -96 LEFT 8
