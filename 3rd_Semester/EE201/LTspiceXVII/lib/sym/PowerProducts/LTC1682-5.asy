...
SYMATTR Value LTC1682-5
SYMATTR Prefix X
SYMATTR SpiceModel LTC1682-5.sub
SYMATTR Value2 LTC1682-5
SYMATTR Description Doubler Charge Pump with Low Noise Linear Regulator, Fixed 5V Output
PIN -144 -96 LEFT 8
