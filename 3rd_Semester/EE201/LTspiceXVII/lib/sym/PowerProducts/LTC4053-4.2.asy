...
SYMATTR SpiceModel LTC4053-4.2
SYMATTR Prefix X
SYMATTR Description USB CompatibleLithion-Ion Battery Charger with Thermal Regulation Themal Current Limit is NOT MODELED
SYMATTR ModelFile LTC4053-4.2.sub
PIN -144 -48 LEFT 8
