...
SYMATTR Value LTC1550CS8-4.1
SYMATTR Prefix X
SYMATTR SpiceModel LTC1550CS8-4.1.sub
SYMATTR Value2 LTC1550CS8-4.1
SYMATTR Description Low Noise, Switched Capacitor Regulated Voltage Inverter, Fixed -4.1V Output
PIN -144 -96 LEFT 8
