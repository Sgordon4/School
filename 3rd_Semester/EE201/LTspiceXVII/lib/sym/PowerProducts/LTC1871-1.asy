...
SYMATTR Value LTC1871-1
SYMATTR Prefix X
SYMATTR SpiceModel LTC1871-1.sub
SYMATTR Value2 LTC1871-1
SYMATTR Description Wide Input Range, No Rsense(TM) Current Mode Boost, Flyback and SEPIC Controller
PIN 160 -144 RIGHT 8
PINATTR PinName Run
