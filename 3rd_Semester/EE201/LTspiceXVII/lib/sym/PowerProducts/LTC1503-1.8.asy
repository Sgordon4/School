...
WINDOW 3 0 65 Center 2
SYMATTR Value LTC1503-1.8
SYMATTR Prefix X
SYMATTR SpiceModel LTC1503-1.8.sub
SYMATTR Value2 LTC1503-1.8
SYMATTR Description High Efficiency Inductorless Step-Down DC/DC Converter, Fixed 1.8V Output
PIN -144 -96 LEFT 8
