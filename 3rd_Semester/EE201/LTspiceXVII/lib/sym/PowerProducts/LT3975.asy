...
SYMATTR Value LT3975
SYMATTR Prefix X
SYMATTR SpiceModel LT3975.sub
SYMATTR Value2 LT3975
SYMATTR Description 42V, 2.5A, 2MHz Step-Down Switching Regulator with 2.7µA Quiescent Current\n\nNote: Sync pin is not modeled; Burst Mode is selected.
PIN 144 192 RIGHT 8
PINATTR PinName FB
