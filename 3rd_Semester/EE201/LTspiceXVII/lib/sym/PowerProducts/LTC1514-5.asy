...
SYMATTR Value LTC1514-5
SYMATTR Prefix X
SYMATTR SpiceModel LTC1514-5.sub
SYMATTR Value2 LTC1514-5
SYMATTR Description Step-Up/Step-Down Switched Capacitor DC/DC Converter with Low-Battery Comparator, Fixed 5V Output
PIN -144 -96 LEFT 8
